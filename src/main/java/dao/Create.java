...
public class Create {
		...
		public void  createUser(String login ,String pw)
		{
			...
			if (!theDir.exists()){
				...
				String path = "C://SGBD//"+login+"//" + login +".txt";
		...
		public  void createDatabase( String st,String login)
		{
			
			String s = anullerEspacesDoubles(st);
			String[] phrase = s.trim().split(" ");
			String db= phrase[2];
			File theDir = new File("C://SGBD//"+login+"//"+db);
			if (!theDir.exists()){
			    theDir.mkdirs();
		...
		public  void  SyntaxeCreateTable (String TableName ,String login, String db) 
		{
			
			String str , tableName  ;
			String s = anullerEspacesDoubles(TableName);
			//System.out.println(s);
			
			String[] phrase = s.trim().split(" ");
		    tableName=phrase[1];
			//System.out.println("TABLENAME    "+tableName);
			createTable(tableName ,login,db);//////////////////////////Foction deja definit pour creer le data file et le meta data file
		...
		//  System.out.println("***&&&&***");
		    System.out.println("roo" + phrase[2]);
		  insertToMetaData(str,tableName,login);   // insert infos in the meta data
		...
		public  void createTable( String TableName ,String login, String db)
		{
			try {
				//il faut ajouter le nom utilisateur dans le path 
				String path = "C://SGBD//"+login+"//"+ this.DB +"//"+ TableName   +"//Data.csv";
			    String metapath = "C://SGBD//"+login+"//"+this.DB +"//"+ TableName + "//metaData.csv";
				File f = new File(path);
		...
		public  void insertToMetaData (String info , String nameTable, String login)
		{
			...
			//System.out.println("-------------------------------------");
			 ...
			 try {
				 ...
				 //	System.out.println(types[1]);
			    	...
			    	FileWriter out = new FileWriter("C://SGBD//"+login+"//"+this.DB +"//"+nameTable+"//metaData.csv",true);
