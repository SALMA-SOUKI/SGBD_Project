            ...
            <li onclick="getDb('${u.getKey()}')">
                ...
                <c:forEach var="tab" items="${u.getValue()}">
                    ...
                    <li  onclick="myFunction('${tab}')" >
                        <a href="#"><i class="fa fa-angle-right leftNavIcon"></i>${tab}  
                                         </a>
                    </li>   
...
<div class="table-wrapper" id="${data_table2.getKey()}"  style="display:none" > <!-- style="display:none" --><!--  id="${data_table2.getKey()}" -->
