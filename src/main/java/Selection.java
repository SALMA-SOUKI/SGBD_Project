...
public class Selection {
	...
	public static void main(String[] args) {
		...
		int pointer = 0;
		Query query = null ;
		query = new Query("get nom,age>etudiants [nom==nouhaila]");
		query.Columns();
		query.TableNames();
		query.Conditions();
		...
		if(query.getColumns().get(0).equals("*")) {
            ...
            File file2 = new File("C:\\"+ query.getTableName().get(0) +"_meta.txt"); //"+query.getTableName().get(0)+"
        ...
        File file = new File("C:\\"+ query.getTableName().get(0) +".txt"); //"+query.getTableName().get(0)+"
        pointer =1;
